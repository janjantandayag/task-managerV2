          <div class="view-window col-md-9">
...
?>
                      ...
                      <tr>
                        ...
                        <td><a href="borrower.php?b_id=<?php echo $borrower_id ?> "><?php echo $borrower ; ?></a></td> 
                        <td><?php echo $due_date ; ?></td> 
                        <td><?php 
                                $result = mysqli_query($connection, "SELECT name FROM documents WHERE ID = $document");
                                      $doc_name = mysqli_fetch_row($result);
                            echo $doc_name[0] ; ?></td>
